...
const std::string kAppServerAddress = "https://api.myim.vip/api/v1/";
...
typedef std::function<void(int res, const std::string& uname, const std::string& token, const std::string& err_msg)> OnLoginAppServerCallback;
...
const static char* g_AppServerAddress = "https://api.myim.vip/api/v1/";
const static char* g_AppKey = "e84f26440a7069797c6341088762755c";
...
namespace nim_comp
{
	...
	public:
		...
		*/
		...
		void LoginAppServer(const std::string &username, const std::string &password, const OnLoginAppServerCallback& cb);
